                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Sign In <a class="btn btn-primary" href="<?php echo e(route('rider.login')); ?>">Rider Login</a></h3>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <a href="<?php echo e(route('register')); ?>" class="btn btn-danger btn-md btn-block waves-effect waves-light text-center m-b-20">Create New Account</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /home6/bloggerc/spaclean.blogger.co.ke/resources/views/auth/login.blade.php ENDPATH**/ ?>