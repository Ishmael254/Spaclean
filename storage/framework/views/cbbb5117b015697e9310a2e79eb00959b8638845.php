...
<li>
<a href="<?php echo e(route('mybazar')); ?>">
<i class="fa fa-bus"></i> My Car Bazar
</a>
</li>
<li>
<a href="<?php echo e(route('network')); ?>">
...
<!-- 
<li class="<?php echo e((request()->segment(1) == 'carbookings') ? 'active' : ''); ?>">
<a href="<?php echo e(route('carbookings')); ?>" class="waves-effect waves-dark">
...
<li class="pcoded-hasmenu <?php echo e((request()->segment(1) == 'carbookings') ? 'active' : ''); ?>" dropdown-icon="style1" subitem-icon="style1">
                                  ...
                                  <li class="<?php echo e((request()->segment(1) == 'carbookings') ? 'active' : ''); ?>">
                                      ...
                                      <li class="<?php echo e((request()->segment(1) == 'mycarbookings') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('mycarbookings')); ?>">
                              ...
                              <li class="pcoded-hasmenu <?php echo e((request()->segment(1) == 'homecare') ? 'active' : ''); ?>" dropdown-icon="style1" subitem-icon="style1">
                                  <a href="javascript:void(0)">
                                  <span class="pcoded-micon"><i class="feather icon-airplay"></i></span>
                                      <span class="pcoded-mtext">HomeCare Bookings</span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                  <li class="<?php echo e((request()->segment(1) == 'homecare') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('homecare')); ?>">
                                              <span class="pcoded-mtext">Book Now</span>
                                          </a>
                                      </li>
                                      <li class="<?php echo e((request()->segment(1) == 'myhomebookings') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('myhomebookings')); ?>">
...
<!-- <li class="<?php echo e((request()->segment(1) == 'homecare') ? 'active' : ''); ?>">
<a href="<?php echo e(route('homecare')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class="<?php echo e((request()->segment(1) == 'market') ? 'active' : ''); ?>">
<a href="<?php echo e(route('market')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<span class="pcoded-mtext">Market </span>
                                ...
                                <li class="pcoded-hasmenu <?php echo e((request()->segment(1) == 'networkconnect') ? 'active' : ''); ?>" dropdown-icon="style1" subitem-icon="style1">
                                  <a href="javascript:void(0)">
                                      <span class="pcoded-micon"><i class="feather icon-server"></i></span>
                                      <span class="pcoded-mtext">Network Connect</span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                  <li class="<?php echo e((request()->segment(1) == 'networkconnect') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('networkconnect')); ?>">
                                              <span class="pcoded-mtext">Network Connect</span>
                                          </a>
                                      </li>
                                      <li class="<?php echo e((request()->segment(1) == 'managenetwork') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('managenetwork')); ?>">
                                              <span class="pcoded-mtext">Manage my Network</span>
                                              <!-- <span class="pcoded-badge label label-info">NEW</span> -->
                                          </a>
                                      </li>
                                      <li class="<?php echo e((request()->segment(1) == 'invitations') ? 'active' : ''); ?>">
                                          <a href="<?php echo e(route('invitations')); ?>">
...
<li class="<?php echo e((request()->segment(1) == 'carbazar') ? 'active' : ''); ?>">
<a href="<?php echo e(route('carbazar')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class="<?php echo e((request()->segment(1) == 'contact') ? 'active' : ''); ?>">
<a href="<?php echo e(route('contact')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class="<?php echo e((request()->segment(1) == 'myprofile') ? 'active' : ''); ?>">
<a href="<?php echo e(route('myprofile')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class="<?php echo e((request()->segment(1) == 'privacy') ? 'active' : ''); ?>">
<a href="<?php echo e(route('privacy')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<!-- <li class="<?php echo e((request()->segment(1) == 'about') ? 'active' : ''); ?>">
<a href="<?php echo e(route('about')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class>
<a href="<?php echo e(route('logout')); ?>" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<?php /**PATH /home6/bloggerc/spaclean.blogger.co.ke/resources/views/layouts/home.blade.php ENDPATH**/ ?>