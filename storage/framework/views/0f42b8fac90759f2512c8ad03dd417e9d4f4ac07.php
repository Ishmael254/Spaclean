...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3">
          <div class="logo">
            <a href="<?php echo e(route('/')); ?>"><img src="http://files.spaclean.co.ke/logo.jpg" style="height:70px; width:200px;" alt="logo"></a>
          </div>
            ...
            <div id="cssmenu">
              <ul id="ul">
                <li><a href="<?php echo e(route('/')); ?>">Home</a></li>   
                    ...
                    <li><a href="<?php echo e(route('allcarbarzars')); ?>">Car Barzar</a></li>  
                    <li><a href="<?php echo e(route('homecareallservices')); ?>">Home Care</a></li>   

         
                </li>

                <li><a href="<?php echo e(route('homecarsales')); ?>">Market</a></li>   
       
                <li><a href="<?php echo e(route('networkconnect')); ?>">Network Connect</a></li>  
                <li><a href="#"> Account</a>
                  <ul>  
                  <?php if(Auth::guest()): ?>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-services footer-widget">
              ...
              <ul>
                <li><a href="<?php echo e(route('carbookings')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Car Wash</a></li>
                <li><a href="<?php echo e(route('allcarbarzars')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Car Barzar</a></li>
                <li><a href="<?php echo e(route('mybazar')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Sell Car</a></li>
                <li><a href="<?php echo e(route('homecareallservices')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Home Care</a></li>
                <li><a href="<?php echo e(route('networkconnect')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Network Connect</a></li>
                <li><a href="<?php echo e(route('homecarsales')); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>Market</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
...
<?php /**PATH /home6/bloggerc/spaclean.blogger.co.ke/resources/views/layouts/myapp.blade.php ENDPATH**/ ?>