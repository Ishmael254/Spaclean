...
<body class="fix-menu">
    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="POST" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Sign up OR <a class="btn btn-primary" href="<?php echo e(route('rider.register')); ?>">Register as Rider</a> </h3>
                                    </div>
                                </div>
                                <div class="form-group form-primary">
                                    ...
                                    ?>
                                    <input type="hidden" value="<?php echo e($ref); ?>" name="unique_id">
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Full Name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" placeholder="Phone Number" name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign in now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home6/bloggerc/spaclean.blogger.co.ke/resources/views/auth/register.blade.php ENDPATH**/ ?>